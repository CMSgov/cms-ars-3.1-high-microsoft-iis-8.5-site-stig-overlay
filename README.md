...
mkdir profiles
cd profiles
git clone https://github.cms.gov/CMSgov/cms-ars-3.1-high-microsoft-iis-8.5-site-stig-overlay.git
...
## Getting Help
To report a bug or feature request, please open an [issue](https://github.cms.gov/CMSgov/cms-ars-3.1-high-microsoft-iis-8.5-site-stig-overlay/issues/new).
